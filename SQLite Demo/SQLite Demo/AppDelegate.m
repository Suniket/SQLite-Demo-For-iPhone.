...
{
    NSString* srcPath = [[NSBundle mainBundle]pathForResource:@"contacts" ofType:@"sqlite"];
    NSArray* arrayPathComp = [NSArray arrayWithObjects:NSHomeDirectory(),@"Documents",@"contacts.sqlite", nil];
